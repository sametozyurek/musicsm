<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="sunutma2.aspx.cs" Inherits="sunutma2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="guncelle">
<h1> Hesabınızı Güncelleyin </h1>
<table>
	<tr>
		<td>
    ...
    <tr>
    	<td>
            <asp:Button ID="btnsdegis" runat="server" Text="Hesabını Güncelle!" Font-Bold="True" 
                Font-Size="X-Large" BackColor="#FF6600" ForeColor="White" Height="45px" 
                Width="227px" onclick="btnkaydet_Click" /></td>
    	<td>
        <div class="lt">
            <asp:Literal ID="ltsifredegisti" runat="server">
